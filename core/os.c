...
/**
 * @brief Append a task to the active timer list.
 * @param[in,out] new_task Task to initialize and append.
 */
...
/**
 * @brief Remove a task from the active timer list.
...
/** @brief Advance active tasks by one tick and dispatch expired callbacks. */
