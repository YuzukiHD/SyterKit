...
static const unsigned char formatStates[] = {0x06, 0x00, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00, 0x10, 0x00, 0x03, 0x06, 0x00, 0x06, 0x02, 0x10, 0x04, 0x45, 0x45,
			...
			case ST_TYPE:
				switch (c) {
					...
					case 'f':
						...
						for (i = 0; i < param.prec; i++) param.values.dvalue /= 10.0;
						...
						for (i = 0; i < param.prec; i++) param.dbl *= 10.0;
