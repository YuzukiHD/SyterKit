...
#include <drivers/dram/sun8iw20/reg.h>
...
static const uint8_t ac_remapping_tables[][22] = {
	...
	[10] = { 0xF, 0x10, 0x16, 0x8, 0x4, 0x9, 0x2, 0xD, 0x13, 0x1, 0xC, 0x3, 0xA, 0x6, 0xE, 0x11, 0x5, 0x12, 0x7,
		0x15, 0x14, 0xB }, // Avaota 86Box Modify
};
...
static void mctl_phy_ac_remapping(const sunxi_dram_t *dram, dram_para_t *para)
{
   ...
   */
	...
	/* enable ac remapping */
	val = readl(dram->registers.mctl_com.base + MCTL_COM_REMAP0);
	val |= BIT(0);
	writel(val, (dram->registers.mctl_com.base + MCTL_COM_REMAP0));
