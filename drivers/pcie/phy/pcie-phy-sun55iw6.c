...
#define pr_fmt(fmt) "pcie-phy-sun55iw6: " fmt
...
#define SUN55IW6_SERDES_PCIE_CLK_MASK  ((1U << 18) | (1U << 17) | (1U << 16) | (1U << 1) | (1U << 0))
...
static void sun55iw6_configure_clocks(const struct pcie_phy *phy, bool enable)
{
	...
	if (enable) {
		pcie_phy_update(ccu + SUN55IW6_CCU_SERDES_BGR, 0U, SUN55IW6_SERDES_CCU_RESET_MASK);
		pcie_phy_update(ccu + SUN55IW6_CCU_PCIE_BGR, 0U, (1U << 17) | (1U << 16));
		pcie_phy_update(
			ccu + SUN55IW6_CCU_PHY_REF, (1U << 31) | (1U << 24) | 0x1fU, (1U << 31) | (1U << 24) | 5U);
		pcie_phy_update(
			ccu + SUN55IW6_CCU_PHY_CFG, (1U << 31) | (1U << 24) | 0x1fU, (1U << 31) | (1U << 24) | 1U);
		pcie_phy_update(
			ccu + SUN55IW6_CCU_SERDES_AXI, (1U << 31) | (0x3U << 24) | 0x1fU, (1U << 31) | (0x1U << 24));
		pcie_phy_update(ccu + SUN55IW6_CCU_SERDES_BGR, 0U, (1U << 1) | (1U << 0));
		/* AUX: 24 MHz HOSC; SLV: 300 MHz peri0 PLL, both undivided. */
		pcie_phy_update(ccu + SUN55IW6_CCU_PCIE_AUX, (1U << 31) | (1U << 24) | 0x1fU, SUN55IW6_PCIE_CLK_ENABLE);
		pcie_phy_update(ccu + SUN55IW6_CCU_PCIE_SLV, (1U << 31) | (1U << 24) | 0x1fU, SUN55IW6_PCIE_CLK_ENABLE);
		pcie_phy_update(ccu + SUN55IW6_CCU_PCIE_BGR, 0U, (1U << 17) | (1U << 16));
		pcie_phy_update(ccu + SUN55IW6_CCU_ITS0_BGR, 0U, SUN55IW6_ITS0_ENABLE_MASK);
		pcie_phy_update(subsys + SUN55IW6_SERDES_PCIE_BGR, 0U, SUN55IW6_SERDES_PCIE_CLK_MASK);
		return;
	}

	pcie_phy_update(subsys + SUN55IW6_SERDES_PCIE_BGR, SUN55IW6_SERDES_PCIE_CLK_MASK, 0U);
	...
	pcie_phy_update(ccu + SUN55IW6_CCU_SERDES_BGR, (1U << 1) | (1U << 0), 0U);
	pcie_phy_update(ccu + SUN55IW6_CCU_PCIE_BGR, (1U << 17) | (1U << 16), 0U);
	pcie_phy_update(ccu + SUN55IW6_CCU_ITS0_BGR, SUN55IW6_ITS0_ENABLE_MASK, 0U);
	pcie_phy_update(ccu + SUN55IW6_CCU_SERDES_BGR, SUN55IW6_SERDES_CCU_RESET_MASK, 0U);
}
...
static void sun55iw6_subsys_phy_enable(const struct pcie_phy *phy)
{
	...
	value = readl(address);
	value &= ~(SUBSYS_PHY_USE_SEL | SUBSYS_PHY_PIPE_SW | SUBSYS_PHY_PIPE_SEL | SUBSYS_PHY_FPGA_SYS_RSTN |
		   SUBSYS_PHY_RSTN);
	writel(value, address);
...
static void sun55iw6_subsys_phy_disable(const struct pcie_phy *phy)
{
	...
	value &= ~(SUBSYS_PHY_USE_SEL | SUBSYS_PHY_PIPE_SW | SUBSYS_PHY_PIPE_SEL | SUBSYS_PHY_RSTN);
	writel(value, address);
}
...
static void sun55iw6_phy_100m_setup(const struct pcie_phy *phy)
{
	...
	pcie_phy_update(base + 0x1004U, (0x3U << 3) | (1U << 0), (1U << 0) | (1U << 2) | (1U << 4));
...
{
	if (phy == NULL || phy->config.subsys_base == 0U || phy->config.phy_base == 0U || phy->config.ccu_base == 0U)
