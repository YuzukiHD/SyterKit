...
void show_chip()
{
	...
	pr_info("Model: Yuzuki Home Kit\n");
	pr_info("Host Core: Arm Dual-Core Cortex-A7 R2P0\n");
	pr_info("AMP Core: Xuantie C906 RISC-V RV64IMAFDCVX R1S0P2 Vlen=128\n");
	...
	case 0x7200:
		pr_info("Chip type = T113M4020DC0");
		break;
	default:
