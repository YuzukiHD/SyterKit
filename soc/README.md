...
I²C buses, PMUs, SID registers, and DRAM/PSRAM timing parameters. These builds do not
...
| sun252iw2 | `sun252iw2_rv32_efex_defconfig` | `init_psram` |
...
DRAM, PSRAM and PMU defaults preserve the existing initialization profiles. Adjust the
