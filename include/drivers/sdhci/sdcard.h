...
#ifndef __SDHCI_SDCARD_H__
#define __SDHCI_SDCARD_H__
...
/**
 * @brief Initialize the SDMMC controller with the specified platform data and SDHCI driver.
 *
...
/**
 * @brief Read data from the SDMMC card into the provided buffer.
 *
 * @param data Pointer to the SDMMC platform data structure.
