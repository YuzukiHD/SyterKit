...
/* pll list */
#define CCMU_PLL_CPUX_CTRL_REG (SUNXI_CCMU_BASE + PLL_CPU_CTRL_REG)
#define CCMU_PLL_DDR0_CTRL_REG (SUNXI_CCMU_BASE + PLL_DDR_CTRL_REG)
#define CCMU_PLL_PERI0_CTRL_REG (SUNXI_CCMU_BASE + PLL_PERI_CTRL_REG)
#define CCMU_PLL_VIDEO_CTRL_REG (SUNXI_CCMU_BASE + PLL_VIDEO_CTRL_REG)
#define CCMU_PLL_AUDIO_CTRL_REG (SUNXI_CCMU_BASE + PLL_AUDIO_CTRL_REG)
#define CCMU_GPADC_BGR_REG (SUNXI_CCMU_BASE + GPADC_BGR_REG)
#define CCMU_CLK_SEL_REG (SUNXI_CCMU_BASE + GPADC_CLK_SEL_REG)
#define CCMU_CLK24M_GATE_EN_REG (SUNXI_CCMU_BASE + CLK24M_GATE_EN_REG)
#define CCMU_AUDIO_CODEC_BGR_REG (SUNXI_CCMU_BASE + AUDIO_CODEC_BGR_REG)

/* pattern list */
#define CCMU_PLL_AUDIO0_PAT0_REG (SUNXI_CCMU_BASE + PLL_AUDIO_PAT0_CTRL_REG)

/* cfg list */
#define CCMU_CPUX_AXI_CFG_REG (SUNXI_CCMU_BASE + CPU_CLK_REG)
#define CCMU_E907_CFG_REG (SUNXI_CCMU_BASE + E907_CLK_REG)
#define CCMU_PSI_AHB1_AHB2_CFG_REG (SUNXI_CCMU_BASE + AHB_CLK_REG)
#define CCMU_APB0_CFG_GREG (SUNXI_CCMU_BASE + APB0_CLK_REG)
#define CCMU_APB1_CFG_GREG (SUNXI_CCMU_BASE + APB1_CLK_REG)
#define CCMU_MBUS_CFG_REG (SUNXI_CCMU_BASE + MBUS_CLK_REG)

#define CCMU_CE_CLK_REG (SUNXI_CCMU_BASE + CE_CLK_REG)
#define CCMU_CE_BGR_REG (SUNXI_CCMU_BASE + CE_BGR_REG)

/*SYS*/
#define CCMU_DMA_BGR_REG (SUNXI_CCMU_BASE + DMA_BGR_REG)
#define CCMU_AVS_CLK_REG (SUNXI_CCMU_BASE + AVS_CLK_REG)

/* storage */
#define CCMU_DRAM_CLK_REG (SUNXI_CCMU_BASE + DRAM_CLK_REG)
#define CCMU_MBUS_MST_CLK_GATING_REG (SUNXI_CCMU_BASE + MBUS_MAT_CLK_GATING_REG)
#define CCMU_DRAM_BGR_REG (SUNXI_CCMU_BASE + DRAM_BGR_REG)

#define CCMU_SDMMC0_CLK_REG (SUNXI_CCMU_BASE + SMHC0_CLK_REG)
#define CCMU_SDMMC1_CLK_REG (SUNXI_CCMU_BASE + SMHC1_CLK_REG)
#define CCMU_SDMMC2_CLK_REG (SUNXI_CCMU_BASE + 0x838)
#define CCMU_SMHC0_BGR_REG (SUNXI_CCMU_BASE + SMHC_BGR_REG)

/*normal interface*/
#define CCMU_UART_BGR_REG (SUNXI_CCMU_BASE + UART_BGR_REG)
#define CCMU_TWI_BGR_REG (SUNXI_CCMU_BASE + TWI_BGR_REG)

#define CCMU_SPI0_CLK_REG (SUNXI_CCMU_BASE + SPI0_CLK_REG)
#define CCMU_SPI1_CLK_REG (SUNXI_CCMU_BASE + SPI1_CLK_REG)
#define CCMU_SPI_BGR_CLK_REG (SUNXI_CCMU_BASE + SPI_BGR_REG)
#define CCMU_USB0_CLK_REG (SUNXI_CCMU_BASE + USB0_CLK_REG)
#define CCMU_USB_BGR_REG (SUNXI_CCMU_BASE + USB_BGR_REG)

/*DMA*/
#define DMA_GATING_BASE CCMU_DMA_BGR_REG
#define DMA_GATING_PASS DMA_BGR_REG_DMA0_GATING_PASS
#define DMA_GATING_BIT DMA_BGR_REG_DMA0_GATING_OFFSET

/*CE*/
#define CE_USE_PLATFORM_CLOCK_FUNC
#define SUNXI_CE_MBUS_MST_CLK_GATE_EN_REG (SUNXI_CCM_BASE + MBUS_MAT_CLK_GATING_REG)
#define SUNXI_CE_MBUS_MST_CLK_GATE_OFFSET MBUS_MAT_CLK_GATING_REG_CE_MBUS_GATE_SW_CFG_OFFSET
#define SUNXI_CE_CLK_REG (SUNXI_CCM_BASE + CE_CLK_REG)
...
/* riscv e907 */
#define E907_SYS_GATING_RESET_BASE (SUNXI_CCMU_BASE + 0xd04)
...
#define E907_CFG_GATING_RESET_BASE (SUNXI_CCMU_BASE + 0xd0c)
