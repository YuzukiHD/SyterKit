...
/* Keep the legacy driver's logging and allocator calls source-compatible. */
...
/*
 * The legacy controller has a global UDC instance.  This separate structure
 * retains the DT-provided controller, clock, and PLIC settings in 0.5.
 */
...
#define SUNXI_USB_DEVICE_WINUSB (1)
...
/* export usb module */
sunxi_usb_module_ext(SUNXI_USB_DEVICE_WINUSB);
