...
/**
 * @file reg.h
 * @brief Register map for the sun50iw10 clock controller.
 */
...
#ifndef __SUN50IW10_CLK_REG_H__
#define __SUN50IW10_CLK_REG_H__
...
#define CCU_PLL_GPU_CTRL_REG (0x30)
#define CCU_PLL_VIDE00_CTRL_REG (0x40)
#define CCU_PLL_VIDE01_CTRL_REG (0x48)
#define CCU_PLL_VIDE02_CTRL_REG (0x50)
#define CCU_PLL_VIDE03_CTRL_REG (0x68)
#define CCU_PLL_VE_CTRL_REG (0x58)
#define CCU_PLL_COM_CTRL_REG (0x60)
#define CCU_PLL_AUDIO_CTRL_REG (0x78)
