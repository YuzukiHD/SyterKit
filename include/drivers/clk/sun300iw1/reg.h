...
/**
 * @file reg.h
 * @brief Register map for the sun300iw1 clock controller.
 */
...
#ifndef __SUN300IW1_CLK_REG_H__
#define __SUN300IW1_CLK_REG_H__
...
#define PLL_OUTPUT_GATE_Disable (PLL_CPU_CTRL_REG_PLL_OUTPUT_GATE_DISABLE << PLL_CPU_CTRL_REG_PLL_OUTPUT_GATE_OFFSET)
