...
/* pll list */
#define CCU_PLL_CPUX_CTRL_REG (CCU_BASE + 0x00)
#define CCU_PLL_DDR0_CTRL_REG (CCU_BASE + 0x10)
...
#define CCU_AHB3_CFG_GREG (CCU_BASE + 0x51C)
#define CCU_APB1_CFG_GREG (CCU_BASE + 0x520)
#define CCU_APB2_CFG_GREG (CCU_BASE + 0x524)
#define CCU_MBUS_CFG_REG (CCU_BASE + 0x540)

#define CCU_CE_CLK_REG (CCU_BASE + 0x680)
#define CCU_CE_BGR_REG (CCU_BASE + 0x68C)

#define CCU_VE_CLK_REG (CCU_BASE + 0x690)
#define CCU_VE_BGR_REG (CCU_BASE + 0x69C)

/*SYS*/
#define CCU_DMA_BGR_REG (CCU_BASE + 0x70C)
#define CCU_AVS_CLK_REG (CCU_BASE + 0x740)
#define CCU_AVS_BGR_REG (CCU_BASE + 0x74C)

/*IOMMU*/
#define CCU_IOMMU_BGR_REG (CCU_BASE + 0x7bc)
...
#define CCU_PLL_DDR_AUX_REG (CCU_BASE + 0x808)
#define CCU_DRAM_BGR_REG (CCU_BASE + 0x80C)

#define CCU_NAND_CLK_REG (CCU_BASE + 0x810)
#define CCU_NAND_BGR_REG (CCU_BASE + 0x82C)

#define CCU_SMHC0_CLK_REG (CCU_BASE + 0x830)
#define CCU_SMHC1_CLK_REG (CCU_BASE + 0x834)
#define CCU_SMHC2_CLK_REG (CCU_BASE + 0x838)
...
#define CCU_SCR_BGR_REG (CCU_BASE + 0x93C)

#define CCU_SPI0_CLK_REG (CCU_BASE + 0x940)
#define CCU_SPI1_CLK_REG (CCU_BASE + 0x944)
#define CCU_SPI_BGR_REG (CCU_BASE + 0x96C)
#define CCU_USB0_CLK_REG (CCU_BASE + 0xA70)
#define CCU_USB_BGR_REG (CCU_BASE + 0xA8C)
...
#define CCU_GPADC_BGR_REG (CCU_BASE + 0x09EC)
