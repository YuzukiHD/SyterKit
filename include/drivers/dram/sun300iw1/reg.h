...
/**
 * @file reg.h
 * @brief Register map for the sun300iw1 DRAM controller.
 */

#ifndef __SUN300IW1_DRAM_REG_H__
#define __SUN300IW1_DRAM_REG_H__
...
#define SUNXI_R_CPUCFG_SUP_STAN_FLAG (SUNXI_PRCM_BASE + 0x01C0)
#define VDD_SYS_PWROFF_GATING_REG (SUNXI_PMU_RTC_BASE + 0x38)
#define ANALOG_PWROFF_GATING_REG (SUNXI_PMU_RTC_BASE + 0x3c)
#define ZQ_CAL_CTRL_REG (SUNXI_SYSCTRL_BASE + 0x160)
#define ZQ_RES_CTRL_REG (SUNXI_SYSCTRL_BASE + 0x168)
#define ZQ_RES_STATUS_REG (SUNXI_SYSCTRL_BASE + 0x16C)

#endif /* __SUN300IW1_DRAM_REG_H__ */
