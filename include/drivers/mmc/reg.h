...
/**
 * @file reg.h
 * @brief Register map for the MMC/SMHC host controller.
 */
...
#define SMHC_RINT_INTERRUPT_ERROR_BIT                                                                          \
	(SMHC_RINT_RESP_ERROR | SMHC_RINT_RESP_CRC_ERROR | SMHC_RINT_DATA_CRC_ERROR | SMHC_RINT_RESP_TIMEOUT | \
		SMHC_RINT_DATA_TIMEOUT | SMHC_RINT_FIFO_RUN_ERROR | SMHC_RINT_HARD_WARE_LOCKED |               \
		SMHC_RINT_START_BIT_ERROR | SMHC_RINT_END_BIT_ERROR) /* 0xbbc2 */
