...
/**
 * @brief Convert a program counter (PC) to Thumb mode address.
 * 
 * This macro modifies the program counter (PC) to ensure it points to a valid Thumb 
 * mode address by setting the least significant bit (LSB) to 1. Thumb instructions 
 * in ARM architecture require that the LSB of the PC is set to 1 to indicate Thumb mode.
 *
