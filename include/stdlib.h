...
/**
 * @brief Convert a string to an unsigned long long integer, with optional base detection.
 *
 * @param cp The input string.
 * @param endp A pointer to the character after the last parsed character.
 * @param base The number base to use for conversion.
...
/**
 * @brief Convert a string in hexadecimal format to an unsigned long integer.
 *
 * @param cp The input string.
 * @param endp A pointer to the character after the last parsed character.
 * @return The converted unsigned long integer value.
...
/**
 * @brief Convert a string in decimal format to an unsigned long integer.
 *
 * @param cp The input string.
 * @param endp A pointer to the character after the last parsed character.
 * @return The converted unsigned long integer value.
...
/**
 * @brief Convert a string to a long integer, with optional base detection.
 *
 * @param cp The input string.
 * @param endp A pointer to the character after the last parsed character.
 * @param base The number base to use for conversion.
 ...
 *
 * @param[in] cp String to parse.
 * @param[out] endp Optional storage for the first unparsed character.
 * @param[in] base Numeric base, or zero to detect it from the prefix.
 * @return Parsed long integer value.
 */
long strtol(const char *cp, char **endp, unsigned int base);

/**
 * @brief Convert a string to an unsigned long integer, with optional base detection, for unsigned strings.
 *
 * @param cp The input string.
 * @param endp A pointer to the character after the last parsed character.
 * @param base The number base to use for conversion.
...
/**
 * @brief Convert a string to an unsigned long long integer, with optional base detection, for unsigned strings.
 *
 * @param cp The input string.
 * @param endp A pointer to the character after the last parsed character.
 * @param base The number base to use for conversion.
...
/**
 * @brief Convert a string to a long long integer, with optional base detection.
 *
 * @param cp The input string.
 * @param endp A pointer to the character after the last parsed character.
 * @param base The number base to use for conversion.
...
/**
 * @brief Convert a string to a long integer, with trailing string checking.
 *
...
/**
 * @brief Convert a long integer to a string representation.
 *
