...
/**
 * @brief Define a bit mask for the specified bit position.
 *
...
/**
 * @brief Clear and set bits in a 32-bit address.
 *
...
/**
 * @brief Set bits in a 32-bit address.
 *
 * @param addr The address to perform the operation on.
 * @param set The bits to set.
 */
...
/**
 * @brief Clear bits in a 32-bit address.
 *
 * @param addr The address to perform the operation on.
 * @param clear The bits to clear.
 */
...
/**
 * @brief Write a byte value to the specified address.
 *
...
/**
 * @brief Read a 16-bit word from the specified address.
 *
 * @param addr The address to read from.
 */
...
/**
 * @brief Write a 16-bit word value to the specified address.
 *
 * @param val The value to write.
 * @param addr The address to write to.
 */
...
/**
 * @brief Read a 32-bit double word from the specified address.
 *
 * @param addr The address to read from.
 */
...
/**
 * @brief Write a 32-bit double word value to the specified address.
 *
 * @param val The value to write.
 * @param addr The address to write to.
 */
...
/**
 * @brief Inline function to read an 8-bit value from the specified address.
 *
 * @param addr The address to read from.
...
/**
 * @brief Inline function to read a 16-bit value from the specified address.
 *
 * @param addr The address to read from.
...
/**
 * @brief Inline function to read a 32-bit value from the specified address.
 *
 * @param addr The address to read from.
...
/**
 * @brief Inline function to read a 64-bit value from the specified address.
 *
 * @param addr The address to read from.
...
/**
 * @brief Inline function to write an 8-bit value to the specified address.
 *
 * @param addr The address to write to.
...
/**
 * @brief Inline function to write a 16-bit value to the specified address.
 *
 * @param addr The address to write to.
...
/**
 * @brief Inline function to write a 32-bit value to the specified address.
 *
 * @param addr The address to write to.
...
/**
 * @brief Inline function to write a 64-bit value to the specified address.
 *
 * @param addr The address to write to.
...
{
	asm volatile("sd %0, 0(%1)" : : "r"(value), "r"(addr));
}
