...
/** @brief Minimum and maximum values a 'signed char' can hold */
...
/** @brief Maximum value an 'unsigned char' can hold (Minimum is 0) */
#define UCHAR_MAX (255) /**< Maximum value for unsigned char */

/** @brief Minimum and maximum values a 'signed short int' can hold */
