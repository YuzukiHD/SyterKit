...
typedef struct boot_file_head {
	...
	/* one intruction jumping to real code */ /**< One instruction jumping to the real code. */
	...
	/* the version of boot_file_head_t */ /**< Version of the boot_file_head_t structure. */
...
__asm__(".section .boot0_head, \"a\", @progbits\n"
	".balign 8\n"
	".global boot_head\n"
