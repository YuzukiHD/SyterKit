...
static int scsi_read_capacity(ufs_device_t *dev, scsi_cmd_t *pccb, uint64_t *capacity, uint64_t *blksz) {
    ...
    *capacity = ((uint64_t) pccb->pdata[0] << 24) | ((uint64_t) pccb->pdata[1] << 16) |
                ((uint64_t) pccb->pdata[2] << 8) | ((uint64_t) pccb->pdata[3]);

    if (*capacity != 0xffffffff) {
        *blksz = ((uint64_t) pccb->pdata[4] << 24) | ((uint64_t) pccb->pdata[5] << 16) |
                 ((uint64_t) pccb->pdata[6] << 8) | ((uint64_t) pccb->pdata[7]);
        return 0;
    }
    ...
    *capacity = ((uint64_t) pccb->pdata[0] << 56) | ((uint64_t) pccb->pdata[1] << 48) |
                ((uint64_t) pccb->pdata[2] << 40) | ((uint64_t) pccb->pdata[3] << 32) |
                ((uint64_t) pccb->pdata[4] << 24) | ((uint64_t) pccb->pdata[5] << 16) |
                ((uint64_t) pccb->pdata[6] << 8) | ((uint64_t) pccb->pdata[7]);

    /*ufs read capacity 16 parameter data logical block length in bytes is only 4 byte*/
    *blksz = ((uint64_t) pccb->pdata[8] << 24) | ((uint64_t) pccb->pdata[9] << 16) |
             ((uint64_t) pccb->pdata[10] << 8) | ((uint64_t) pccb->pdata[11]);
