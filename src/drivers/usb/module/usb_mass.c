...
sunxi_usb_module_init(SUNXI_USB_DEVICE_MASS, sunxi_usb_mass_init, sunxi_mass_exit, sunxi_mass_reset, sunxi_mass_standard_req_op,
                      sunxi_mass_nonstandard_req_op, sunxi_mass_state_loop, sunxi_mass_usb_rx_dma_isr, sunxi_mass_usb_tx_dma_isr);
