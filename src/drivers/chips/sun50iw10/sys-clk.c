...
static inline void set_modules_clock(void) {
	...
	uint32_t ccmu_pll_addr[] = {
			CCU_BASE + CCU_PLL_PERI0_CTRL_REG,	CCU_BASE + CCU_PLL_PERI1_CTRL_REG,	CCU_BASE + CCU_PLL_GPU_CTRL_REG,	CCU_BASE + CCU_PLL_VIDE00_CTRL_REG,
			CCU_BASE + CCU_PLL_VIDE01_CTRL_REG, CCU_BASE + CCU_PLL_VIDE02_CTRL_REG, CCU_BASE + CCU_PLL_VIDE03_CTRL_REG, CCU_BASE + CCU_PLL_VE_CTRL_REG,
			CCU_BASE + CCU_PLL_COM_CTRL_REG,	CCU_BASE + CCU_PLL_AUDIO_CTRL_REG,
	};
